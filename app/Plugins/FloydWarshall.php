    ...
    */
    public function print_graph () {
        ...
        //if ( empty($_SERVER['argv']) ) {
            ...
            $print_table = '<table border="1" cellpadding="4" width="100%">';
            $print_table .= '<tbody>';
            $print_table .= '<tr><td></td>';
            
            for ($i = 0; $i < $this->nodes; $i++) {
                $print_table .= '<td align="center">
                                    <strong>' .$this->nodenames[$i] .'</strong>
                                </td>';
            };
            $print_table .= '<tr>';
            for ($i = 0; $i < $this->nodes; $i++) {
                $print_table .= '<tr><td>'.$this->nodenames[$i].'</td>';
                for ($j = 0; $j < $this->nodes; $j++) {
                    $print_table .= '<td  align="center"><strong>' .
                                        $this->weights[$i][$j] .
                                        '</strong>
                                    </td>';
                }
            ...
            //                     <strong>' .$this->nodenames[0] .'</strong>
            //                 </td>
            //             </tr>
            //             <tr>
